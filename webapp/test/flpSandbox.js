		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Comparative Analysis MD",
									"targetURL": "#mdcomparativeanalysis-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mdcomparativeanalysis-display": {
								"semanticObject": "mdcomparativeanalysis",
								"action": "display",
								"description": "Comparative Analysis MD",
								"title": "Comparative Analysis MD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mdcomparativeanalysis",
									"url": sap.ui.require.toUrl("mdcomparativeanalysis")
								}
							}
						}
					}
